...
st.set_page_config(page_title="Clasificador de imágenes de lesiones cutáneas", page_icon="U+1FA7A", layout="wide")
...
with st.container():
    # Descargar y cargar el modelo desde Google Drive si no está en caché
    MODEL_PATH = "mejor_modelo_entrenamiento_vgg16.keras"
    if not os.path.exists(MODEL_PATH):
        MODEL_URL = "https://drive.google.com/uc?id=1HzTQnIyQIP9BRiYiqFEqJHM4FNfcqsGu"
    ...
    if uploaded_file is not None:
        ...
        if predicted_class_idx in class_labels:
            ...
            st.warning("Recuerda siempre asistir al centro sanitario en cualquier circunstancia de dudas en el diagnóstico")
        else:
